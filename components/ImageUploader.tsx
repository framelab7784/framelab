...
export const ImageUploader: React.FC<ImageUploaderProps> = ({ files, onFilesChange, maxFiles = 1, label }) => {
  ...
  return (
    <div>
      ...
      <div
        className="group relative flex justify-center items-center w-full h-40 rounded-lg border-2 border-dashed border-gray-700 hover:border-lime-500 transition-colors duration-300 cursor-pointer bg-gray-800/50"
